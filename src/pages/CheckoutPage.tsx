            ...
            <Card className="rounded-3xl shadow-lg border-gray-200">
              <CardContent className="p-16">
                ...
                <RadioGroup
                  ...
                  className="space-y-5"
                >
                  <div className="flex items-center gap-4 p-4 rounded-xl hover:bg-blue-50 transition-all duration-200 cursor-pointer border-2 border-transparent hover:border-blue-400">
                    <RadioGroupItem
                      value="razorpay"
                      id="razorpay"
                  ...
                  <div className={`flex items-center gap-4 p-4 rounded-xl transition-all duration-200 border-2 ${
                    !isCodAllowed
                      ? 'opacity-50 cursor-not-allowed bg-gray-50 border-gray-200'
                      : 'cursor-pointer hover:bg-blue-50 border-transparent hover:border-blue-400'
                  }`}>
                    <RadioGroupItem
                      value="cod"
                      id="cod"
